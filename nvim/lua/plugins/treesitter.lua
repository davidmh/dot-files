...
return {{"nvim-treesitter/nvim-treesitter-textobjects", name = "nvim-treesitter-textobjects"}, {"nvim-treesitter/nvim-treesitter", dependencies = {"nvim-treesitter-textobjects"}, build = ":TSUpdate", config = config}, {"davidmh/mdx.nvim", dependencies = {"nvim-treesitter/nvim-treesitter"}, config = true}}
