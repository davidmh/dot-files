...
return {{"fsouza/nvim-treesitter-textobjects", name = "nvim-treesitter-textobjects", branch = "fennel-fix"}, {"nvim-treesitter/nvim-treesitter", dependencies = {"nvim-treesitter-textobjects", "JoosepAlviste/nvim-ts-context-commentstring", "numToStr/Comment.nvim"}, build = ":TSUpdate", config = config}, {"davidmh/mdx.nvim", dependencies = {"nvim-treesitter/nvim-treesitter"}, config = true}}
