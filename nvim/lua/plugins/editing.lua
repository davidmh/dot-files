...
return {"junegunn/vim-slash", {"mg979/vim-visual-multi", keys = {{"<c-n>", mode = {"n", "v"}}, {"\\\\A", mode = {"n", "v"}}}}, {"willothy/flatten.nvim", opts = {window = {open = "smart"}}, tag = "v0.5.1"}, {"AndrewRadev/switch.vim", config = config_switch, event = "VeryLazy"}, {"tommcdo/vim-exchange", keys = {"cx", "cX", {"X", mode = "v"}}}, {"junegunn/vim-easy-align", keys = {{"ga", "<Plug>(EasyAlign)", mode = {"x", "n"}}}}}
