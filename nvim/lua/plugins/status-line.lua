...
git_block = {container({{provider = _42_}, {provider = _43_, condition = has_git_diff("added")}, {provider = _44_, condition = has_git_diff("changed")}, {provider = _45_, condition = has_git_diff("removed")}}), condition = _46_, init = _47_, hl = {bg = chrome_accent}}
local git_blame
local function _48_()
  return (vim.o.filetype == "fugitiveblame")
end
git_blame = {container({{provider = "git blame", hl = {bold = true}}}), condition = _48_}
local term_title
