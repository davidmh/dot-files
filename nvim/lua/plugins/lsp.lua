...
return {{"folke/lazydev.nvim", ft = "lua", opts = {library = {{path = "${3rd}/luv/library", words = {"vim%.uv"}}, "nvim-dap-ui"}}}, {"neovim/nvim-lspconfig", dependencies = {"b0o/SchemaStore.nvim", "folke/lazydev.nvim"}, config = lsp_config}, {"j-hui/fidget.nvim", event = "LspAttach", opts = {notification = {window = {align = "top", border = "none", y_padding = 2}}}}, {"SmiteshP/nvim-navic", opts = {depth_limit = 4, depth_limit_indicator = " [ \238\169\188 ] ", click = true, highlight = true, icons = cfg["navic-icons"], separator = " \238\170\182 ", safe_output = false}}}
