...
vim.diagnostic.config({underline = true, signs = {text = cfg.icons}, severity_sort = true, float = {header = "", border = cfg.border, format = diagnostic_format}, update_in_insert = false, virtual_text = false})
