...
return {{"s1n7ax/nvim-window-picker", event = "VeryLazy", config = true}, {"nvim-neo-tree/neo-tree.nvim", branch = "v3.x", dependencies = {"nvim-lua/plenary.nvim", "nvim-tree/nvim-web-devicons", "MunifTanjim/nui.nvim", "s1n7ax/nvim-window-picker"}, opts = {filesystem = {filtered_items = {hide_dotfiles = false}}, window = {mappings = {["-"] = {git_2fstage_unstage, desc = "stage/unstage"}, X = {"git_revert_file", desc = "revert"}}}}, keys = {{"<leader>fe", "<cmd>Neotree toggle reveal<cr>", desc = "explore"}, {"<leader>ff", "<cmd>Neotree focus reveal<cr>", desc = "focus"}, {"<leader>fv", "<cmd>vsplit | Neotree current reveal<cr>", desc = "in vertical split"}, {"<leader>fs", "<cmd>split | Neotree current reveal<cr>", desc = "in horizontal split"}, {"<leader>fw", "<cmd>Neotree current reveal<cr>", desc = "in current window"}, {"<leader>fg", "<cmd>Neotree source=git_status reveal<cr>", desc = "git status"}, {"<leader>be", "<cmd>Neotree buffers reveal<cr>", desc = "explore"}, {"<leader>bv", "<cmd>vsplit | Neotree buffers current reveal<cr>", desc = "buffers in vertical split"}, {"<leader>bs", "<cmd>split | Neotree buffers current reveal<cr>", desc = "buffers in horizontal split"}, {"<leader>bw", "<cmd>Neotree buffers current reveal<cr>", desc = "buffers in current window"}}}}
