...
return {"folke/snacks.nvim", priority = 1000, opts = {bigfile = {enabled = true}, words = {enabled = true}, notifier = {enabled = true, margin = {bottom = 1, right = 0}, top_down = false}, statuscolumn = {enabled = true}, dashboard = {enabled = true, preset = {header = get(quotes, math.random(#quotes))}, sections = {{section = "header"}, {icon = "\239\131\133", title = "Recent files", section = "recent_files", indent = 2, padding = 1}, {icon = "\238\171\183", title = "Projects", section = "projects", indent = 2, action = find_files, padding = 1}, {section = "startup"}}}, styles = {notification = {border = border}, notification_history = {border = border}}}, lazy = false}
