...
return {"zbirenbaum/copilot.lua", event = "InsertEnter", opts = {suggestion = {enabled = true, auto_trigger = true, keymap = {next = "<m-n>", prev = "<m-p>", accept = "<m-y>", accept_word = "<m-w>", accept_line = "<m-l>", dismiss = "<m-[>"}}, panel = {enabled = true}, filetypes = {clojure = true, gitcommit = true, go = true, javascript = true, typescript = true, typescriptreact = true, toggleterm = true, fennel = true, less = true, lua = true, nix = true, python = true, ruby = true, rust = true, zsh = _2_, norg = true, sh = true, sql = true, ["*"] = false}}}
