...
local function config()
  ...
  gmap("<space>", _14_, "files in git HEAD")
...
return {{"lewis6991/gitsigns.nvim", opts = {signcolumn = true, current_line_blame = false}, config = true}, {"sindrets/diffview.nvim", opts = {key_bindings = {disable_defaults = false}}, config = true}, {"tpope/vim-git", dependencies = {"nvim-lua/plenary.nvim", "sindrets/diffview.nvim", "lewis6991/gitsigns.nvim"}, event = "VeryLazy", config = config}, {"tpope/vim-fugitive", dependencies = {"tpope/vim-rhubarb"}}, {"NeogitOrg/neogit", dependencies = {"nvim-lua/plenary.nvim", "sindrets/diffview.nvim", "nvim-telescope/telescope.nvim"}, opts = {disable_hint = true, fetch_after_checkout = true, graph_style = "unicode", notification_icon = "\238\156\130", recent_commit_count = 15, auto_close_console = false, remember_settings = false}, cmd = {"Neogit", "NeogitLogCurrent"}}}
