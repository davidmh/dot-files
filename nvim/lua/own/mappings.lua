...
vim.keymap.set("n", "<localleader>no", _26_, opts("open notifications"))
local function _27_()
  return vim.notify.dismiss()
end
vim.keymap.set("n", "<localleader>nd", _27_, opts("dismiss notifications"))
local function _28_()
  return projects["select-project"]()
end
vim.keymap.set("n", "<localleader>p", _28_, opts("switch projects"))
...
vim.keymap.set("n", "[d", _29_, opts("next diagnostic"))
local function _30_()
  return vim.diagnostic.goto_next(error_filter)
end
vim.keymap.set("n", "]d", _30_, opts("previous diagnostic"))
local function _31_()
  return vim.diagnostic.goto_prev(warning_filter)
end
vim.keymap.set("n", "[w", _31_, opts("next warning"))
local function _32_()
  return vim.diagnostic.goto_next(warning_filter)
end
vim.keymap.set("n", "]w", _32_, opts("previous warning"))
