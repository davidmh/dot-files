...
vim.diagnostic.config({underline = true, severity_sort = true, float = {header = "", border = config.border, format = diagnostic_format}, virtual_text = false, update_in_insert = false, signs = false})
