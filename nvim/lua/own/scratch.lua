...
local function initialize()
  ...
  vim.api.nvim_buf_set_lines(bufnr, 0, 0, true, {"(local {: compile-all-files} (require :nfnl))", "(local nvim-path (vim.fn.stdpath :config))", "", "(comment", "  (compile-all-files nvim-path)"})
